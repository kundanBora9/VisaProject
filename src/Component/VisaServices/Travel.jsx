  ...
  return (
    ...
    <div className="relative">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-6xl text-center">
              <h1 className="poppins-semibold text-4xl">VISITOR/TRAVEL VISA </h1>
              <Breadcrumb
    ...
    <div className="container flex flex-col md:flex-row lg:flex-row justify-evenly items-center mt-10 poppins-regular">
      <div className="w-full md:w-1/2 p-4">
        <h2 className="text-[#303F9F] text-5xl poppins-semibold">VISITOR/TRAVEL VISA</h2>
        <p className="text-xl mt-10 poppins-regular">
        MVTS India specializes in providing comprehensive visa facilitation services for travelers and B2B travel partners seeking Visitor and Travel Visas assistance. With a dedicated focus on customer satisfaction and efficient processing, we offer tailored solutions to meet the diverse needs of individuals and businesses alike. Our experienced team members ensure smooth and hassle-free visa applications assistance, guiding clients through every step of the process with expertise and professionalism. Whether you're planning a leisure trip or coordinating travel arrangements for your clients, MVTS India is committed to delivering reliable and timely visa consultancy services to help you achieve your travel goals.
        </p>
      </div>
